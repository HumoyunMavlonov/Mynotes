...
import uz.gita.mynotesgitaacademy.DateChange
import uz.gita.mynotesgitaacademy.R
import uz.gita.mynotesgitaacademy.database.Note
import uz.gita.mynotesgitaacademy.databinding.ActivityEditBinding
    ...
    override fun onClick(v: View) {
        when (v.id) {
            R.id.nib_back -> {
                AwesomeDialog.build(this)
                    .position(AwesomeDialog.POSITIONS.CENTER)
                    .body("Do you want leave ?", color = ContextCompat.getColor(this, R.color.colorTitle))
                    .background(R.drawable.background_dialog)
                    .icon(R.mipmap.ic_launcher)
                    .onPositive(
                        "Don`t save and exit",
